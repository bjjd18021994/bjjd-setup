...
```bash
helm install platform-ingress ./platform-ingress-chart -n default
```

Upgrade:

```bash
helm upgrade platform-ingress ./platform-ingress-chart -n default
```

Uninstall:

```bash
helm uninstall platform-ingress -n default
```
